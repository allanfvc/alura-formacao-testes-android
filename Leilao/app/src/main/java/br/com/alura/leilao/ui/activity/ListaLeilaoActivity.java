...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        computador.propoe(new Lance(new Usuario("Fran"), 2000.00));
        computador.propoe(new Lance(new Usuario("Alex"), 3000.00));
        computador.propoe(new Lance(new Usuario("Alex"), 4000.00));
